...
title: "Reference Amounts Customarily Consumed: List of Products for Each Product Category"
date: "2018/03"
url: https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category
crawled: "2026-03-25T14:44:16.709179"
chars: 6579
---

- [Skip to main content](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category#main-content)
- [Skip to FDA Search](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category#search-form)
- [Skip to in this section menu](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category#section-nav)
- [Skip to footer links](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category#footer)

[In this section:\\
\\
Search for FDA Guidance Documents](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category#section-nav)
...
4. Guidance for Industry: Reference Amounts Customarily Consumed (List of Products for Each Product Category)
...
Docket Number:[FDA-2016-D-4098](https://www.regulations.gov/docket/FDA-2016-D-4098)Issued by:
...
This guidance will help industry identify the product category to which specific products belong, but is not meant to provide an all-inclusive list of products that are available on the market for each product category.

FDA's guidance documents, including this guidance, do not establish legally enforceable responsibilities.

Instead, guidances describe our current thinking on a topic and should be viewed only as recommendations, unless specific regulatory or statutory requirements are cited. The use of the word _should_ in FDA guidances means that something is suggested or recommended, but not required.

* * *

## Related Information

- [Changes to the Nutrition Facts Label](https://www.fda.gov/food/labeling-nutrition/changes-nutrition-facts-label)

* * *

## Submit Comments

[Submit Comments Online](https://www.regulations.gov/docket/FDA-2016-D-4098/document)
...
All written comments should be identified with this document's docket number: [FDA-2016-D-4098](https://www.regulations.gov/docket/FDA-2016-D-4098).
...
[Back to Top](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-reference-amounts-customarily-consumed-list-products-each-product-category)
